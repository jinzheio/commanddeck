...
interface IpcHandlers {
  ...
  getDeployStatus: (payload: { projectName: string; force?: boolean } | string) => any;
}
...
export function registerIpc(ipcMain: IpcMain, handlers: IpcHandlers): void {
  ...
  ipcMain.handle("github:getDeployStatus", (_event, payload) => handlers.getDeployStatus(payload));
}
